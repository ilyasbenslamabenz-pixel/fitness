const CACHE='evo-fit-coach-v23';
self.addEventListener('install',e=>e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./manifest.json','./icon.svg','./ilyas-icon.jpg'])).then(()=>self.skipWaiting())));
